  ...
  run: async (client, interaction) => {
    ...
    try {
      if (!queue || !queue.playing) {
        return interaction.reply({ content: '⚠️ Музыка не проигрывается!! | ⚠️ No music playing!!', ephemeral: true });
      }
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(success ? '** Музыка поставлена на паузу!! | The music has been Paused for a moment!!**' : '❌ Ошибка! Невозможно поставить на паузу! | ❌ Command Error: Unable to pause song')
